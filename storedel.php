...
<br />
<h2>Delete Store Details on basis of:</h2>
<br />
<center>
<form method="POST" #action="http://www.google.com/search">
<table>
<tr>
<td><input type="radio" name="manid" > Store ID </td>
<td><input type="radio" name="manname" > Store Name </td>
</table>
<br />
...
<?php
	...
	{
		header("Location:storedel.php");
	}	
	else if(isset($_POST['MID']) && isset($_POST['manid']))
	{
		//echo "1";
		$query = "DELETE FROM store WHERE SID=".$_POST['MID'].";";
	}
	else if(isset($_POST['MID']) && isset($_POST['manname']))
	{
		$query = "DELETE FROM store WHERE Name LIKE '%".$_POST['MID'].";";
	}
